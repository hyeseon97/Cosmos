...
('자전거 동호회 1픽','산악 동호회랑도 같이 갔음 마운틴뷰 짱','강원 원주시 원골길 5','고급/친구/산/맑음/눈','yeonju'),
('자전거 타면서 단풍구경','은행냄새 안나요 걱정하지 마세요','대전 서구 장태산','가을/친구/산','chunsic'),
('가족이랑 자전거 여행','두발자전거, 세발자전거, 커플자전거, 레일바이크','경기 의왕시 왕송못동로 221','가족/여름/가을','ironman'),
('인생최고코스','대청호를 옆에 두고 시원하게 달려보자','대전 대덕구 대청호','혼자/친구/초급/도시','hyeseon'),
('겨울맛집 자전거 코스','눈길위로 자전거 타고 현대아울렛 놀러가기','대전 대덕구 신탄진','겨울/눈/가족','santa'),
